...
require (
	...
	github.com/go-orb/plugins/client/middleware/log v0.1.1-0.20250307142109-89a0ed05b479
	...
	github.com/go-orb/plugins/registry/memory v0.0.0-20250307142109-89a0ed05b479
