...
import (
	...
	echohandler "github.com/go-orb/examples/benchmarks/rps/handler/echo"
	echopb "github.com/go-orb/examples/benchmarks/rps/proto/echo"
...
func provideServerOpts() ([]server.Option, error) {
	...
	return []server.Option{
		...
		mhertz.WithEntrypoint(
			...
			mhertz.WithInsecure(),
			mhertz.WithRegistration("Streams", echopb.RegisterEchoService(hInstance)),
		),
		mhertz.WithEntrypoint(
